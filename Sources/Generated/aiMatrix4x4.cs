...
public class aiMatrix4x4 : global::System.IDisposable, Interface.Unmanagable<aiMatrix4x4> {
  ...
  public static aiMatrix4x4 RotationX(float a, aiMatrix4x4 out_) {
    aiMatrix4x4 ret = new aiMatrix4x4(assimp_swigPINVOKE.aiMatrix4x4_RotationX(a, aiMatrix4x4.getCPtr(out_)), false);
    if (assimp_swigPINVOKE.SWIGPendingException.Pending) throw assimp_swigPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static aiMatrix4x4 RotationY(float a, aiMatrix4x4 out_) {
    aiMatrix4x4 ret = new aiMatrix4x4(assimp_swigPINVOKE.aiMatrix4x4_RotationY(a, aiMatrix4x4.getCPtr(out_)), false);
    if (assimp_swigPINVOKE.SWIGPendingException.Pending) throw assimp_swigPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static aiMatrix4x4 RotationZ(float a, aiMatrix4x4 out_) {
    aiMatrix4x4 ret = new aiMatrix4x4(assimp_swigPINVOKE.aiMatrix4x4_RotationZ(a, aiMatrix4x4.getCPtr(out_)), false);
    if (assimp_swigPINVOKE.SWIGPendingException.Pending) throw assimp_swigPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static aiMatrix4x4 Translation(aiVector3D v, aiMatrix4x4 out_) {
    aiMatrix4x4 ret = new aiMatrix4x4(assimp_swigPINVOKE.aiMatrix4x4_Translation(aiVector3D.getCPtr(v), aiMatrix4x4.getCPtr(out_)), false);
    if (assimp_swigPINVOKE.SWIGPendingException.Pending) throw assimp_swigPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
